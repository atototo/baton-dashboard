...
export const executionWorkspaces = pgTable("execution_workspaces", {
	...
	lastPrCheckedAt: timestamp("last_pr_checked_at", { withTimezone: true, mode: 'string' }),
	...
	lastDriftDetectedAt: timestamp("last_drift_detected_at", { withTimezone: true, mode: 'string' }),
	recoveryStatus: text("recovery_status"),
	recoveryReason: text("recovery_reason"),
	recoveryRequestedAt: timestamp("recovery_requested_at", { withTimezone: true, mode: 'string' }),
	recoveryStartedAt: timestamp("recovery_started_at", { withTimezone: true, mode: 'string' }),
	recoveryFinishedAt: timestamp("recovery_finished_at", { withTimezone: true, mode: 'string' }),
